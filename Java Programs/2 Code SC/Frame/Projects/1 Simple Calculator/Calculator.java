...
public class Calculator implements ActionListener
{
    ...
    public void actionPerformed(ActionEvent e) 
    {
        ...
        if( string.equals("+"))
        {
            ...
            Double double1 = new Double(result);
            textField3.setText(double1.toString());
        }
        else if( string.equals("-"))
        {
            double result = num1 - num2;
            @SuppressWarnings("removal")
            Double double2 = new Double(result);
            textField3.setText(double2.toString());
        }
        else if( string.equals("*"))
        {
            double result = num1 * num2;
            @SuppressWarnings("removal")
            Double double3 = new Double(result);
            textField3.setText(double3.toString());
        }
        else if( string.equals("/"))
        {
            double result = num1 / num2;
            @SuppressWarnings("removal")
            Double double4 = new Double(result);
            textField3.setText(double4.toString());
        }
        else if( string.equals("%"))
        {
            double result = num1 % num2;
            @SuppressWarnings("removal")
            Double double5 = new Double(result);
            textField3.setText(double5.toString());
        }
    }   
}