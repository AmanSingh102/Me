    ...
    if( option == 1 ):
        ...
        if( student == {} ):
            ...
            if modify_roll in student:
                ...
                print(f"{modify_roll} roll no. not found....")            
...
'''
                    print(datatype_menu)
                    data_type = int(input(f"Emter type of the value : "))

                    if( data_type == 1 ):
                        value = input(f"Enter value for {newfield_name} : ")
                    elif( data_type == 2 ):
                        value = int(input(f"Enter value for {newfield_name} : "))
                    elif( data_type == 3 ):
                        value = float(input(f"Enter value for {newfield_name} : "))
                    else:
                        print("Invalid Input !!!!")
                        break
                    
                    student[add_field_roll][newfield_name] = value
                    print(f"{newfield_name} field added successfully...........")
                    
                    print() 

            else:
                print(f"{add_field_roll} roll no. not found....")
